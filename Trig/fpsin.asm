...
.link .requires trigdata
              ...
              plo      rd
              call     addtows      ; add to workspace
sincos:       call     getargs      ; angle = angle * angle
              db       29,29
              call     mulfpi       ; angle = angle * angle
sincos_l:     call     getargs      ; need to see if sum == last
              db       9,1
...
sincos_1:     ldn      rd           ; get byte from sum
              ...
              call     getargs      ; pwr = pwr * angle
              db       5,29
              call     mulfpi
              call     getargs      ; fct = facts[fctPos]
              db       17,13
