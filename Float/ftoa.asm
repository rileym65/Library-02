...
ftoa_3a:      glo      r9           ; get exponent
              ...
              ldi      fp_10.0
              plo      rd
              call     divfpi       ; perform the division
              irx                   ; recover E
              ldx
              adi      1            ; increment E
...
ftoa_4a:      glo      r9           ; get exponent
              ...
              ldi      fp_10.0
              plo      rd
              call     mulfpi       ; perform the division
              irx                   ; recover E
              ldx
              smi      1            ; decrement E
              phi      r9           ; and put it back
...
ftoa_8:       irx                     ; recover destination
              ...
              glo      r9
              stxd
              call     itoa32       ; call itoa to convert integer portion of result
...
ftoa_e1:      ldi      0            ; place E as 32-bits onto stack
              ...
              phi      rf
              inc      rf
              call     itoa32       ; call itoa to display E
              irx                   ; remove number from stack
              irx
              irx
              irx
